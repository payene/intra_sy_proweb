...
class GrhStartController extends Controller {
    ...
    public function merryChristmsAction(Request $request){
        ...
        // $msg = "<h2> Que notre collaboration perdure en cette nouvelle année 2018.Tous nos vœux de bonheur et prospérité.</>";
        ...
        GrhContratsController::payeneSfMailerStatic($receivers, "no-reply@prowebgroupe.com", "Joyeux Noel 2017", $messageBody, $this);
