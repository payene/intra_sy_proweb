...
//        dump($prochains_array);
    ...
    private function createEditForm(GrhEmployes $entity) {
        ...
        $form->add('submit', LegacyFormHelper::getType('Symfony\Component\Form\Extension\Core\Type\SubmitType'), array('label' => 'Enregistrer les modifications', 'attr' => ['class' => 'btn btn-warning']));
