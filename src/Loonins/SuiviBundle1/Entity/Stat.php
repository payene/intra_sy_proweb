...
class Stat
{
    ...
    // * @ORM\PreUpdate
    // **/
    // public function timeSeconds() {
    //     $reel = $this->explodeTime($this->getReel());
    //     $prg = $this->explodeTime($this->getProgrammed());
     ...
     * @var string
     *
     * @ORM\Column(name="programmed", type="string", length=5)
     */
    private $programmed;
     ...
     * @var integer
     *
     * @ORM\Column(name="programmedSeconds", type="integer")
     */
   ...
   /**
     ...
     * @var integer
     *
     * @ORM\Column(name="nbCaractere", type="integer")
    */
     ...
     * @var integer
     *
     * @ORM\Column(name="totalRecu", type="integer")
    */
    private $totalRecu =0;
     ...
     * @var integer
     *
     * @ORM\Column(name="nbInscTrait", type="integer")
    */
     ...
     * @var integer
     *
     * @ORM\Column(name="nbAbonnes", type="integer")
    */
    private $nbAbonnes =0;
     ...
     * @var integer
     *
     * @ORM\Column(name="heureAbs", type="integer")
    */
    private $heureAbs =0;
     ...
     * @var integer
     *
     * @ORM\Column(name="noteCoach", type="integer")
    */
    private $noteCoach =0;
    /**
     * @var text
